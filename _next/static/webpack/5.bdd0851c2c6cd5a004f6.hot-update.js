...
var Immunity = function Immunity(props) {
  ...
  var sketch = function sketch(p) {
    ...
    var setupPopulation = function setupPopulation() {
      ...
      population[1] = new _Person__WEBPACK_IMPORTED_MODULE_3__["default"]({
        x: 170,
        y: 48,
        horizontalSpeed: 0,
        verticalSpeed: 0,
        radius: 30,
        state: _DiseaseState__WEBPACK_IMPORTED_MODULE_4__["default"].CURED,
        p5: p
      });
    };
    ...
    p.draw = function () {
      ...
      population.forEach(function (person) {
        ...
        population.forEach(function (other) {
          ...
          if (other.state === _DiseaseState__WEBPACK_IMPORTED_MODULE_4__["default"].FATAL) return;
          ...
          if (Object(_Physics__WEBPACK_IMPORTED_MODULE_5__["checkCollision"])(person, other)) {
            ...
            person.state = _DiseaseState__WEBPACK_IMPORTED_MODULE_4__["default"].INFECTED;
            other.state = _DiseaseState__WEBPACK_IMPORTED_MODULE_4__["default"].INFECTED;
          }
        });
        person.render();
      });
...
//# sourceMappingURL=5.bdd0851c2c6cd5a004f6.hot-update.js.map